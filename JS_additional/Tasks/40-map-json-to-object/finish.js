...
const parsed = postsJSON.map((element) => JSON.parse(element));
//or
// const parsed = postsJSON.map(JSON.parse);
console.log(parsed);

console.log(parsed[1].postId);
console.log(parsed[3].commentsQuantity);